...
if __name__ == "__main__":  
    ...
    '''数据加载'''
    parser.add_argument('--task', default='0429', help='')
    parser.add_argument('--run_name', type=str, default='reg2379')
    parser.add_argument('--val_name', type=str, default='fu486')
    parser.add_argument('--train_size', default=2379, help='')
    parser.add_argument('--val_size', default=486, help='')
    ...
    args['load_path']='outputs/0428/reg2379/epoch-{}.pt'.format(499)

    # for xxx in range(0,403):
    #     args['load_path']='outputs/0427/reg2379/epoch-{}.pt'.format(xxx)
    '''初始化网络/测试已有网络'''
    if args['load_path'] == '':
